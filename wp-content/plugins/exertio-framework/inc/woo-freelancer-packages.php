		...
		function exertio_freelancer_order_status_completed( $order_id )
		{
			...
			foreach ( $items as $item )
			{
				...
				if($prduct_type == 'freelancer-packages') 
				{
					...
					if($ext_project_credits == -1)
					{
						$project_credits = $ext_project_credits;
					}
					...
					if($ext_simple_services == -1)
					{
						$simple_services = $ext_simple_services;
					}
					...
					if($ext_simple_services_expiry == -1)
					{
						$simple_services_expiry = $ext_simple_services_expiry;
					}
					...
					if($ext_featured_services == -1)
					{
						$featured_services = $ext_featured_services;
					}
					...
					if($ext_featured_services_expiry == -1)
					{
						$featured_services_expiry = $ext_featured_services_expiry;
					}
					...
					if($ext_freelancer_package_expiry == -1)
					{
						$freelancer_package_expiry = $ext_freelancer_package_expiry;
					}
