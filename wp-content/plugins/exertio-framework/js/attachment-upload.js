...
var meta_gallery_frame_event;
	  ...
	  jQuery(document).on('click', 'a.close-thik', function() {
			...
			jQuery(document).ready(function(){
				...
				var fieldHTML = '<div class="ui-state-default"><span class="dashicons dashicons-move"></span><input type="url" name="video_urls[]" value=""/><a href="javascript:void(0);" class="remove_button"><img src="'+exertio_localize_vars.pluginUrl+'/images/error.png" >	</a></div>'; //New input field html 
		...
		meta_gallery_frame_event.on('select', function() {
			...
			images_event.each(function(attachment_eventz) {
				...
				imageIDArray.push(attachment_eventz.attributes.id);
					...
					if (typeof attachment_eventz.attributes.sizes.thumbnail === 'undefined') {
						imageHTML += '<li id="data-'+attachment_eventz.attributes.id+'"><span class="freelance_icon_brand"><img id="'+attachment_eventz.attributes.id+'" src="'+attachment_eventz.attributes.url+'"></span></li>';
					}
					else
					{
						imageHTML += '<li id="data-'+attachment_eventz.attributes.id+'"><span class="freelance_icon_brand"><img id="'+attachment_eventz.attributes.id+'" src="'+attachment_eventz.attributes.sizes.thumbnail.url+'"></span></li>';
					}
