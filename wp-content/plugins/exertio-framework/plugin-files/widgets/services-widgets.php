...
class exertio_services_keyword_widget extends WP_Widget
{
	function __construct()
	{
		...
		__('Exertio Services - Filter By Keyword', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by keyword widget', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_category_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By Category', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by category', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_english_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By English Level', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by English Level', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_response_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By Response Time', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by Response time', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_delivery_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By Delivery Time', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by Delivery time', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_location_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By Location', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by Location', 'exertio_theme' ), ) 
		);
	}
...
class exertio_services_price_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Services - Filter By Price', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Services Search by Price', 'exertio_theme' ), ) 
		);
	}
