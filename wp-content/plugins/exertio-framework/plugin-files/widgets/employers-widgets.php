...
class exertio_employer_keyword_widget extends WP_Widget
{
	function __construct()
	{
		...
		__('Exertio Employer - Filter By Keyword', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Employer Search by keyword widget', 'exertio_theme' ), ) 
		);
	}
          ...
          <div id="search-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
              <div class="form-group">
                <input type="text" class="form-control" name="title" placeholder="<?php echo __( 'Keyword or employer name', 'exertio_theme' ); ?>" value="<?php echo esc_attr($title_value); ?>">
              </div>
            </div>
          </div>
        </div>
...
class exertio_employer_department_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Employer - Filter By Category', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Employer Search by department', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="department-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('departments','department')
					?>
                </ul>
            </div>
          </div>
...
class exertio_employer_count_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Employer - Filter By No of Employees', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Employer Search by Number of Emplyees', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="employer-count-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('employees-number','no-of-employees')
					?>
                </ul>
            </div>
          </div>
...
class exertio_employer_location_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Employer - Filter By Location', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Employer Search by Location', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="employer-location-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('employer-locations','location')
					?>
                </ul>
            </div>
          </div>
