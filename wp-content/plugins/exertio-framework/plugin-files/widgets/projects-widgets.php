...
class exertio_projects_keyword_widget extends WP_Widget
{
	function __construct()
	{
		...
		__('Exertio Projects - Filter By Keyword', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Prokject Search by keyword widget', 'exertio_theme' ), ) 
		);
	}
	...
	public function form( $instance )
	{
		...
		{
			$title = __( 'New title', 'exertio_theme' );
		}
        ...
        <div class="form-group">
          ...
          <select class="widefat" id="<?php echo esc_attr($this->get_field_id( 'is_collaspe' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'is_collaspe' )); ?>">
          	<option value="close" <?php if(isset($instance['is_collaspe']) && $instance['is_collaspe'] == 'close') { echo 'selected'; } ?>> <?php echo __( 'Close', 'exertio_theme' ); ?></option>
            <option value="open" <?php if(isset($instance['is_collaspe']) && $instance['is_collaspe'] == 'open') { echo 'selected'; } ?>><?php echo __( 'Open', 'exertio_theme' ); ?></option>
          </select>
         </div>
		</p>
		<?php 
...
class exertio_project_category_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Category', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by category', 'exertio_theme' ), ) 
		);
	}
...
class exertio_project_freelncer_type_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Freelancer Type', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by freelancer type', 'exertio_theme' ), ) 
		);
	}
...
class exertio_projects_price_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Price', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Price', 'exertio_theme' ), ) 
		);
	}
	...
	public function form( $instance )
	{
		...
		{
			$max_range = __( '100', 'exertio_theme' );
		}
		// Widget admin form
        ...
        <div class="form-group">
		  <label for="<?php echo esc_attr($this->get_field_id( 'min_range' )); ?>">
			<?php echo __( 'Minimum Range', 'exertio_theme' ); ?>
		  </label>
        ...
        <div class="form-group">
		  <label for="<?php echo esc_attr($this->get_field_id( 'max_range' )); ?>">
			<?php echo __( 'Maximum Range', 'exertio_theme' ); ?>
		  </label>
...
class exertio_project_duration_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Duration', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Duration', 'exertio_theme' ), ) 
		);
	}
...
class exertio_project_level_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Level', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Level', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="project-level-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('project-level','project-level')
					?>
                </ul>
            </div>
          </div>
...
class exertio_project_english_level_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By English Level', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by English Level', 'exertio_theme' ), ) 
		);
	}
...
class exertio_project_locations_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Location', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Location', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="locations-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('locations','location')
					?>
                </ul>
            </div>
          </div>
...
class exertio_project_skills_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Skills', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Skills', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="skills-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('skills','skill')
					?>
                </ul>
            </div>
          </div>
...
class exertio_project_languages_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Languages', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Languages', 'exertio_theme' ), ) 
		);
	}
        ...
        <div class="panel panel-default">
          ...
          <div id="languages-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                <ul class="main">
                	<?php
					echo exertio_get_search_terms('languages','language')
					?>
                </ul>
            </div>
          </div>
...
class exertio_project_price_type_widget extends WP_Widget
{
	function __construct()
	{
		...
		// Widget name will appear in UI
		__('Exertio Projects - Filter By Price Type', 'exertio_theme'), 
		  
		// Widget description
		array( 'description' => __( 'Projects Search by Price Type', 'exertio_theme' ), ) 
		);
	}
          ...
          <div id="price-type-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
            <div class="panel-body">
                ...
                <select class="default-select" name="price-type">
                	<option value=""><?php echo __( 'Select price type', 'exertio_theme' ); ?></option>
                    <option value="fixed" <?php if($price_type == 'fixed') { echo 'selected="selected"'; } ?>><?php echo __( 'Fixed Price', 'exertio_theme' ); ?></option>
                    <option value="hourly" <?php if($price_type == 'hourly') { echo 'selected="selected"'; } ?>><?php echo __( 'Hourly Price', 'exertio_theme' ); ?></option>
                </select>
            </div>
          </div>
        </div>
