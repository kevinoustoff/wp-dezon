...
class Hero_Two extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hero Section 2', 'exertio-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'multiple' => true,
				'options' => [
						'Projects'  => __( 'Projects', 'exertio-elementor' ),
						'Services'  => __( 'Services', 'exertio-elementor' ),
						'Employers'  => __( 'Employers', 'exertio-elementor' ),
						'Freelancer'  => __( 'Freelancer', 'exertio-elementor' ),
				],
				'label_block' => true
			]
		);
		...
		$params['keyword_post_type'] = $settings['keyword_post_type'];
			...
			echo exertio_element_hero_two($params);
