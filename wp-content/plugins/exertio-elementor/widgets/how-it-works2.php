...
class How_it_Works_Two extends Widget_Base {
	
	public function get_name() {
		return 'how-it-works-2';
	}
	
	public function get_title() {
		return __( 'How It Works Two', 'exertio-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$params['grid_cols'] = $settings['grid_cols'];

			echo exertio_element_howit_works_two($params);
		}
