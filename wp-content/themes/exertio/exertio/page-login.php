      ...
      <div class="col-lg-6 col-xs-12 col-sm-12 col-xl-6 col-md-12 align-self-center no-padding-hero">
        <div class="fr-sign-container">
            ...
            <form  id="signin-form">
              <div class="fr-sign-form">
                ...
                <div class="form-group">
                  <input type="text"  name="fl_email" placeholder="<?php echo esc_html__('Email','exertio_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_html__('Renseignez votre email','exertio_theme'); ?>">
                </div>
              </div>
              <div class="fr-sign-form">
              ...
              <div class="fr-sigin-requirements">
                ...
                <span class="sr-style"> <?php echo esc_html__('Me garder connecté','exertio_theme'); ?></span> <a href="#"  data-bs-toggle="modal" data-bs-target="#forget_pwd"> <span> <?php echo esc_html__('Mot de passe oublié','exertio_theme'); ?></span></a> </div>
              <div class="fr-sign-submit">
                <div class="form-group d-grid">
                  <button type="button" class="btn btn-theme btn-block btn-loading" id="signin-btn"> <?php echo esc_html__('Se connecter','exertio_theme'); ?>
          ...
          <div class="fr-sign-bundle-content">
            <p> <?php echo esc_html__('Vous n\'avez pas de compte?','exertio_theme'); ?> <span><a href="<?php echo get_the_permalink($exertio_theme_options['register_page']); ?>"><?php echo esc_html__('Inscrivez-vous ici','exertio_theme'); ?></a></span></p>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><?php echo esc_html__('Mot de passe oublié','exertio_theme'); ?></h5>
        ...
        <div class="modal-body">
          <form id="fl-forget-form">
            <div class="fr-sign-form">
              <div class="fr-sign-logo"> <img src="<?php echo get_template_directory_uri(); ?>/images/icons/mail.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid"> </div>
              <div class="form-group">
                <input type="email"  name="fl_forget_email" placeholder="<?php echo esc_html__('Email de votre compte','exertio_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_html__('Renseignez l\'email de votre compte','exertio_theme'); ?>">
              </div>
            </div>
            <div class="form-group">
              <button type="button" class="btn btn-theme btn-block btn-loading" id="forget_btn"><?php echo esc_html__('Réinitialisez le mot de passe','exertio_theme'); ?>
              <span class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </span>
              </button>
