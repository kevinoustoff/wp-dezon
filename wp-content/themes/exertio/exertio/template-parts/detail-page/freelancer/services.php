								  ...
								  <div class="item">
									<div class="fr-top-contents">
									  <div class="fr-top-product">
										...
										{
											echo '<div class="fr-top-featured"> <span class="badge">'.esc_html__( 'Sponsorisé', 'exertio_theme' ).'</span> </div>';
										}
									  ...
									  <div class="fr-top-details">
										...
										<p><?php echo esc_html__('A partir de ','exertio_theme'); ?><span class="style-6"><?php echo fl_price_separator(get_post_meta($sid, '_service_price', true), 'html'); ?></span></p>
