          ...
          <div class="col-lg-9 col-xl-9 col-xs-12 col-md-9 col-sm-12">
            <div class="fr-hero-details-content">
              <div class="fr-hero-details-information">
                <span class="title"><i class="fa fa-check"></i><?php echo esc_html(get_post_meta( $fl_id, '_freelancer_dispaly_name' , true )); ?></span>
                ...
                <div class="fr-hero-m-deails">
                  <ul>
                    ...
                    ?>
                    <li> <span> <?php echo esc_html__('Member since ','exertio_theme').date_i18n( get_option( 'date_format' ), strtotime( get_the_date('dS M Y') ) ); ?></span> </li>
			...
			?>
              <div class="fr-hero-short-list-2">
                <div class="fr-hero-hire-content">
					...
					?>
                	<a href="javascript:void(0)" class="follow-freelancer protip" data-fid="<?php echo esc_html($fl_id); ?>" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_html($save_text); ?>"><i class="fa fa-heart <?php echo esc_attr($active_saved); ?>"></i></a>
                    <a href="#" class="btn btn-theme"><?php echo esc_html__('Hire Me','exertio_theme'); ?></a>
                </div>
              </div>
            </div>
          </div>
			...
			?>
                  <div class="col-lg-12 col-xl-12 col-xs-12 col-md-12 col-sm-12">
                    <div class="fr-hero-m-jobs">
                        <ul>
                            <li> <span>350</span> <?php echo esc_html__('Ongoing Projects','exertio_theme'); ?></li>
                            <li> <span>610</span>  <?php echo esc_html__('Completed Projects','exertio_theme'); ?></li>
                            <li> <span>550</span>  <?php echo esc_html__('Services in Queue','exertio_theme'); ?></li>
                            <li> <span>550</span> <?php echo esc_html__('Completed Services ','exertio_theme'); ?></li>
                        </ul>
                    </div>
                  </div>
          <?php
