		...
		<div class="col-md-12 grid-margin">
		  <div class="d-flex justify-content-between flex-wrap">
			...
			<div class="d-flex justify-content-between align-items-end flex-wrap">
			  <button class="btn btn-theme-secondary mt-2 mt-xl-0" data-toggle="modal" data-target="#dispute-modal"><?php echo esc_html__('Create Dispute','exertio_theme'); ?></button>
			</div>
		  </div>
		</div>
	  </div>
        ...
        <div class="card-body">
          <div class="pro-section">
            <div class="pro-box heading-row">
              ...
              <div class="pro-coulmn"><?php echo esc_html__( 'Project', 'exertio_theme' ) ?> </div>
            ...
            <div class="pro-box">
              ...
              <div class="pro-coulmn">
                <?php  echo esc_html(date_i18n( get_option( 'date_format' ), strtotime( get_the_date($pid) ) )); ?>
              </div>
              <div class="pro-coulmn">
                <?php
                $badge_color = '';
        ...
        <div class="stretch-card">
          <div class="deposit-box card">
              ...
              <form id="despute-project-form">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="dispute_title" required data-smk-msg="<?php echo esc_html__('This field is required','exertio_theme'); ?>" >
                  </div>
                  <div class="form-group col-md-12">
                    <label> <?php echo esc_html__('Description','exertio_theme'); ?></label>
                    <textarea class="form-control" name="dispute_description" rows="3" required data-smk-msg="<?php echo esc_html__('This field is required','exertio_theme'); ?>"></textarea>
            ...
            <div class="deposit-footer">
              <button type="button" id="despute-project-btn" class="btn-loading"> <?php echo esc_html__('Submit Dispute','exertio_theme'); ?>
              <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div>
              </button>
              <input type="hidden" id="fl_despute_nonce" value="<?php echo wp_create_nonce('fl_despute_secure'); ?>"  />
            </div>
          </div>
        </div>
      </div>
