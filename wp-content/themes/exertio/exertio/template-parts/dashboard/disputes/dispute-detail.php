                                        ...
                                        <form id="send_himstory_msg">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <textarea name="dispute_msg_text" id="" class="form-control" placeholder="<?php echo esc_html__('Write your message here....','exertio_theme'); ?>" required data-smk-msg="<?php echo esc_html__('Please provide message to send','exertio_theme'); ?>"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
