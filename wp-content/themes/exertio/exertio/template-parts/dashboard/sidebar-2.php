    ...
    <li class="profile">
      ...
      <li class="nav-item <?php if($page_name == 'add-services' || $page_name == 'all-services' || $page_name == 'pending-services' || $page_name == 'ongoing-services' || $page_name == 'canceled-services') { echo 'active';} ?>">
        ...
        <div class="collapse <?php if($page_name == 'add-services' || $page_name == 'all-services' || $page_name == 'pending-services' || $page_name == 'ongoing-services' || $page_name == 'canceled-services' || $page_name == 'completed-services' || $page_name == 'completed-service-detail' || $page_name == 'ongoing-service-detail' || $page_name == 'canceled-service-detail') { echo 'show';} ?>" id="services">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item <?php if($page_name == 'add-services') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=add-services">  <?php echo esc_html__( 'Ajouter un service', 'exertio_theme' ); ?></a></li>
            <li class="nav-item <?php if($page_name == 'all-services') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=all-services"> <?php echo esc_html__( 'Services validés', 'exertio_theme' ); ?> </a></li>
            <li class="nav-item <?php if($page_name == 'pending-services') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=pending-services"> <?php echo esc_html__( 'Services en attente', 'exertio_theme' ); ?> </a></li>
            <li class="nav-item <?php if($page_name == 'ongoing-services') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=ongoing-services"><?php echo esc_html__( 'Services en cours', 'exertio_theme' ); ?> </a></li>
            ...
            <li class="nav-item <?php if($page_name == 'canceled-services') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=canceled-services"> <?php echo esc_html__( 'Services rejetés', 'exertio_theme' ); ?> </a></li>
          </ul>
        </div>
      </li>
			...
			if ($dashboard_page != '')
			{
				...
				<li class="nav-item">
					<a class="nav-link" href="<?php echo esc_url(get_permalink($dashboard_page));?>" target="_blank">
					  ...
					  <span class="menu-title"><?php echo esc_html__( 'Messagerie', 'exertio_theme' ); ?></span>
					</a>
				</li>
				<?php
			}
      ...
      <li class="nav-item <?php if($page_name == 'disputes') { echo 'active';} ?>">
        <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=disputes">
          ...
          <span class="menu-title"><?php echo esc_html__( 'Litiges', 'exertio_theme' ); ?> </span>
        </a>
      </li>
