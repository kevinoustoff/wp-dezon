	...
	<div class="col-md-12 grid-margin">
	  <div class="d-flex justify-content-between flex-wrap align-items-center">
		<div class="d-flex flex-wrap flex-column">
		  <div class="mr-md-3 mr-xl-5 d-flex">
			<h2><?php echo esc_html__('Content de vous revoir,', 'exertio_theme' ); ?></h2>
		  </div>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Projets publiés', 'exertio_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=projects"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Projets en vedette', 'exertio_theme' ); ?></span>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Projets en cours', 'exertio_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count_ongoing); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=ongoing-project"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Projets finalisés', 'exertio_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count_completed); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?completed-projects"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xl-8 col-lg-12 col-md-12 stretch-card">
		  <div class="card  grid-margin">
			<div class="card-body">
			  <h4 class="card-title"><?php echo esc_html__('Vue(s) du profil', 'exertio_theme' ); ?></h4>
			  <div class="chart-box"><canvas id="bar-chart" height="175"></canvas></div>         
			</div>
		  </div>
			<div class="card grid-margin all-proposals">
				<div class="card-body">
				  <h4 class="card-title"> <?php echo esc_html__('Propositions récentes', 'exertio_theme' ); ?></h4>
				  <div class="pro-section">
					  <div class="pro-box heading-row">
						<div class="pro-coulmn pro-title"><?php echo esc_html__( 'Détail de la proposition', 'exertio_theme' ); ?></div>
						...
						<?php
							...
							if ( $result != null )
							{
								...
								foreach($result as $results)
								{
									...
									$posted_date = $results->updated_on;
											...
											{
												$project_cost .=  esc_html(fl_price_separator($results->proposed_cost));
												$project_cost .=  '<span class="protip" data-pt-title="'.__('In ','exertio_theme').$days_to_complete.__(' hours total will be  ','exertio_theme'). fl_price_separator($days_to_complete*$results->proposed_cost).'" data-pt-position="top" data-pt-scheme="black"><i class="far fa-question-circle"></i></span>';
											}
							...
							else
							{
								...
								<div class="nothing-found">
									...
									<h3><?php echo esc_html__( 'Désolé!! Aucune proposition trouvée', 'exertio_theme' ) ?></h3>
								</div>
								<?php	
							}
						?>
		...
		<div class="col-xl-4 col-lg-12 col-md-12 stretch-card">
			<div class="card grid-margin most-viewed-widget">
				<div class="card-body">
					<h4 class="card-title"><?php echo esc_html__('Les projets les plus vus', 'exertio_theme' ); ?></h4>
					<div class="listing-widgets">
						<ul>
							<?php
									...
									while ( $most_listings->have_posts() )
									{
										...
										$project_cost = '';
											...
											else if($type == 'hourly')
											{
												...
												$hourly_total_price = '';
												if (is_numeric($estimated_hours) && is_numeric($prject_price))
												{
													$hourly_total_price = $estimated_hours*$prject_price;
												}
												$project_cost .=  '<span class="protip" data-pt-title="'.__('Pour ','exertio_theme').$estimated_hours.__(' hours total will be  ','exertio_theme'). fl_price_separator($hourly_total_price).'" data-pt-position="top" data-pt-scheme="black"><i class="far fa-question-circle"></i></span>';
											}
									?>
											<li>
								...
								{
									echo exertio_no_result_found('','Aucune donnée disponible');
								}
							?>
						</ul>
					</div>
			...
			<div class="card grid-margin tips package-info current-package-widget">
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Pack actuel', 'exertio_theme' ); ?></h4>
					<p class="view-more-btn"> <a href="<?php echo get_the_permalink(fl_framework_get_options('emp_package_page')); ?>?ext=buy-package" target="_blank"> <?php echo esc_html__(' Voir les packs ', 'exertio_theme' ); ?></a></p>
					<?php
					...
					if(isset($simple_project) && $simple_project != '')
					{
						...
						?>
						<ul>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Projet autorisé: ', 'exertio_theme' ).'</span>'.esc_html($simple_project_text)?> </li>
							...
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Expiration du projet en vedette: ', 'exertio_theme' ).'</span>'.esc_html($featured_project_expiry_text); ?> </li>
							...
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Expiration du package: ', 'exertio_theme' ).'</span>'.esc_html($package_expiry_text) ?> </li>
						</ul>
						<?php
					}
					else
					{
						echo '<p>'.esc_html__(' Aucun détail disponible pour le pack', 'exertio_theme' ).'</p>';
					}
					?>
			  </div>
			</div>
