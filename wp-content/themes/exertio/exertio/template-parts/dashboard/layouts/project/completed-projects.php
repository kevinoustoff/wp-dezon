	...
	if( is_user_logged_in() )
	 {
		$title = '';
		$meta_query= '';					
		$the_query = fl_get_projects($title,$current_user_id, $meta_query, 'completed');
                                ...
                                while ( $the_query->have_posts() ) 
                                {
                                    ...
                                    ?>
                                      <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn"><a href="<?php get_template_part( 'project-propsals' );?>?ext=completed-project-detail&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'Voir le détail', 'exertio_theme' ); ?></a></div>
                                      </div>
                                    <?php
                                }
                            }
