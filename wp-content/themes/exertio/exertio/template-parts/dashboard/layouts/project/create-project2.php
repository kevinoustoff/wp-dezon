			  ...
			  <div class="row">
				<div class="col-xl-8 col-lg-12 col-md-12 grid-margin stretch-card">
					...
					<form id="project_form" enctype="multipart/form-data">
						...
						<div class="card-body">
						  ...
						  <div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input type="text" class="form-control" placeholder="Exemple: Réalisation de clip video" name="project_name" value="<?php echo esc_attr($post->post_title); ?>" <?php if(fl_framework_get_options('project_title') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez donner un titre à votre demande','exertio_theme'); } ?>">
						  ...
						  <div class="form-row">
							<div class="form-group col-md-6">
								  <label><?php echo esc_html__('Catégorie','exertio_theme'); ?></label>
								   ...
								   $project_category = '';
									...
									{
										$project_category = "required data-smk-msg='".esc_html__("Veuillez sélectionner la catégorie appropriée","exertio_theme")."'"; 
									}
								  $category_taxonomies = exertio_get_terms('project-categories');
									if ( !empty($category_taxonomies) )
									{
										
										echo '<select name="project_category" class="form-control general_select" '.$project_category.'>'.get_hierarchical_terms('project-categories', '_project_category', $pid ).'</select>';
									}
								?>
								</div>
							<?php
							...
							else
							{
								?>
								<div class="form-group col-md-6">
								  <label><?php echo esc_html__('Type de prestataire souhaité','exertio_theme'); ?></label>
								  <?php
								  
									$feelancer_type_chk = '';
									if(fl_framework_get_options('project_freelancer_type') == 1)
									{
										$feelancer_type_chk = "required data-smk-msg='".esc_html__("Veuillez renseigner le type de prestataire souhaité","exertio_theme")."'"; 
									}
								  $freelancer_taxonomies = exertio_get_terms('freelancer-type');
									if ( !empty($freelancer_taxonomies) )
									{
										...
										$freelancer .= '<option value=""> '. __( "Type de prestataire", "exertio_theme" ) .'</option>';
						  ...
						  <div class="form-row">
							<div class="form-group col-md-6">
							  <label><?php echo esc_html__('Type de rémunération','exertio_theme'); ?></label>
								<?php 
									...
									$not_disabled = '';
									if(isset($project_type) && $project_type == 'hourly')
									{
								...
								?>
								<select name="project_type" class="form-control general_select project-type" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez renseigner le type de rémunération','exertio_theme'); } ?>" >
									<option value=""> <?php echo esc_html__( "Selectionner le type de rémunération", "exertio_theme" ); ?></option>
									<option value="hourly" <?php if($project_type== 'hourly') {echo 'selected';} ?>><?php echo esc_html__('Par heure','exertio_theme'); ?></option>
									<option value="fixed" <?php if($project_type== 'fixed') {echo 'selected';} ?>><?php echo esc_html__('Fixe','exertio_theme'); ?></option>
								</select>
							</div>
							
							<div class="form-group col-md-6 fixed-field" <?php echo esc_attr($hide); ?> >
							  <label><?php echo esc_html__(' Prix','exertio_theme'); ?></label>
							  <input type="text" class="form-control" name="project_cost" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez saisir le prix de la rémunération','exertio_theme'); }?>" <?php echo esc_attr($not_disabled); ?>>
							</div>
							<div class="form-group col-md-6 hourly-field" <?php echo esc_attr($show); ?> >
							  <label><?php echo esc_html__('Par heure','exertio_theme'); ?></label>
							  <input type="text" class="form-control" name="project_cost_hourly" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez renseigner le prix par heure','exertio_theme'); }?>" <?php echo esc_attr($disabled); ?>>
							</div>
							<div class="form-group col-md-12 hourly-field" <?php echo esc_attr($show); ?>>
							  <label><?php echo esc_html__(' Nombre d\'heures estimé','exertio_theme'); ?></label>
							  <input type="text" class="form-control" name="estimated_hours" value="<?php echo esc_attr(get_post_meta($pid, '_estimated_hours', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez saisir le nombre d\'heures estimé','exertio_theme'); }?>" <?php echo esc_attr($disabled); ?>>
							</div>
						  </div>
						  <div class="form-row">
							<?php
							...
							else
							{
								...
								{
									$duration_chk = 'required data-smk-msg="'.esc_html__("Veuillez saisir la durée du projet","exertio_theme").'"'; 
								}
							
							?>
								<div class="form-group col-md-6">
									<label><?php echo esc_html__('Durée du projet','exertio_theme'); ?></label>
								  <?php
									...
									if ( !empty($duration_taxonomies) )
									{
										...
										$duration .= '<option value=""> '. __( "Sélectionner la durée du projet", "exertio_theme" ) .'</option>';
							...
							else
							{
								...
								{
									$level_chk = 'required data-smk-msg="'.esc_html__("Please select project level","exertio_theme").'"'; 
								}
							...
							else
							{
								...
								{
									$eng_level_chk = 'required data-smk-msg="'.esc_html__("Please select english level","exertio_theme").'"'; 
								}
								?>
								<div class="form-group col-md-6">
							...
							else
							{
								...
								{
									$location_chk = 'required data-smk-msg="'.esc_html__("Veuillez renseigner un pays","exertio_theme").'"'; 
								}
								?>
								<div class="form-group col-md-6">
									  <label><?php echo esc_html__('Pays','exertio_theme'); ?></label>
									  <?php
						  ...
						  <?php
							...
							else
							{
								...
								{
									$skills_chk = 'required data-smk-msg="'.esc_html__("Veuillez renseigner les compétences requises","exertio_theme").'"'; 
								}
							
								?>
							  <div class="form-row">
								<div class="form-group col-md-12">
								  <label><?php echo esc_html__('Compétences requises','exertio_theme'); ?></label>
								  <?php
								  ...
								  $saved_skills = wp_get_post_terms($pid, 'skills', array( 'fields' => 'all' ));
									if ( !empty($skills_taxonomies) )
									{
										...
										$skill .= '<option value=""> '. __( "Sélectionner les compétences requises", "exertio_theme" ) .'</option>';
							...
							else
							{
								...
								{
									$languages_chk = 'required data-smk-msg="'.esc_html__("Sélectionner les compétences requises","exertio_theme").'"'; 
								}
							
								?>
								  <div class="form-row">
									<div class="form-group col-md-12">
									  <label><?php echo esc_html__('Langues requises','exertio_theme'); ?></label>
									  <?php
									  ...
									  $saved_language = wp_get_post_terms($pid, 'languages', array( 'fields' => 'all' ));
										if ( !empty($language_taxonomies) )
										{
											...
											$language .= '<option value=""> '. __( "Selectionner les langues", "exertio_theme" ) .'</option>';
					  ...
					  <div class="card mb-4">
						<div class="card-body">
						  <h4 class="card-title"><?php echo esc_html__('Détail du projet','exertio_theme'); ?></h4>
						  <div class="form-row">
								<div class="form-group col-md-12">                  	
									<label>Description</label> 
									<textarea name="project_desc" class="form-control fl-textarea" id="" placeholder="<?php echo esc_html__('Saisir la description ici','exertio_theme'); ?>"><?php echo esc_html($post->post_content); ?></textarea>
								</div>
							</div>
						</div>
					  </div>
					  ...
					  <?php $pro_img_id = get_post_meta( $pid, '_project_attachment_ids', true ); ?>
						<div class="card-body project-attachments">
						  ...
						  <div class="form-row">
								<div class="form-group col-md-12"> 
									<label>Voulez-vous ajouter des fichiers PDF ou Word au projet?</label> 
							...
							<div class="form-row img-wrapper" <?php echo esc_attr($display); ?>>
								<div class="form-group col-md-12">
									<div class="upload-btn-wrapper">
										<button class="btn btn-theme-secondary mt-2 mt-xl-0" type="button"><?php echo esc_html__('Uploader le fichier','exertio_theme'); ?></button>
												...
												$icon = get_icon_for_attachment($value);
													...
													echo '<div class="attachments ui-state-default  pro-atta-'.$value.'">
															...
															<span class="attachment-data">
																...
																<a href="javascript:void(0)" class="btn-pro-clsoe-icon" data-id="'.$value.'" data-pid="'.$pid.'"> <i class="fal fa-times-circle"></i></a>
															</span>
														</div>';
											}
										}
					  ...
					  <?php
						...
						?>
						  <div class="card mb-4">
							<div class="card-body">
							  <h4 class="card-title"><?php echo esc_html__('Localisation du client','exertio_theme'); ?></h4>
							...
							<script>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-12">
								  ...
								  <input type="text" class="form-control" name="project_address" id="searchMapInput" value="<?php echo get_post_meta($pid, '_project_address', true); ?>" <?php if(fl_framework_get_options('project_address') == 1){ ?>required data-smk-msg="<?php echo esc_html__('Veuillez renseigner l\'adresse','exertio_theme'); }?>">
							...
							<div class="card-body">
								<div class="featured-box">
									<?php
										...
										{
											?>
											<h4><?php echo esc_html__('Déjà sponsorisé','exertio_theme');  ?></h4>
											<p><?php echo esc_html(fl_framework_get_options('mark_featured_desc'));  ?></p>
											<?php
										}
									?>
								...
								<button type="button" class="btn btn-theme" id="create_project_btn" data-post-id="<?php echo esc_attr($pid) ?>">
										<?php 
											...
											{
												echo esc_html__('Publier','exertio_theme');
											}
											else
											{
												echo esc_html__('Modifier','exertio_theme');
											}
										?>
				...
				<div class="col-xl-4 col-lg-12 col-md-12 grid-margin stretch-card">
					...
					<div class="card mb-4 vector-bg tips">
						<div class="card-body">
						<h4 class="card-title"><?php echo esc_html__('Etapes pour publier un projet :','exertio_theme'); ?></h4>
						  <?php
							$count = 1;
				  ...
				  <h4 class="card-title"><?php echo esc_html__('Abonnement actuel', 'exertio_theme' ); ?></h4>
					...
					<?php
						...
						$simple_project_text = isset( $simple_project) && $simple_project == -1 ? esc_html__(' Illimité ', 'exertio_theme' ) : $simple_project;
					
						$simple_project_expiry = get_post_meta( $employer_id, '_simple_project_expiry', true);
						$simple_project_expiry_text = isset( $simple_project_expiry) && $simple_project_expiry == -1 ? esc_html__(' N\'expire jamais', 'exertio_theme' ) : $simple_project_expiry.esc_html__(' Jours ', 'exertio_theme' );
					...
					if(isset($simple_project) && $simple_project != '')
					{
						...
						?>
						<ul>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Projets autorisés: ', 'exertio_theme' ).'</span>'.esc_html($simple_project_text)?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Expiration du projet: ', 'exertio_theme' ).'</span>'.esc_html($simple_project_expiry_text) ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Projets en vedette: ', 'exertio_theme' ).'</span>'.esc_html($featured_projects_text);?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Expiration des projets en vedette: ', 'exertio_theme' ).'</span>'.esc_html($featured_project_expiry_text); ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Profil en vedette: ', 'exertio_theme' ).'</span>'.esc_html($employer_featured_text); ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Expiration du pack: ', 'exertio_theme' ).'</span>'.esc_html($package_expiry_text) ?> </li>
						</ul>
						<?php
					}
					else
					{
						echo '<p>'.esc_html__(' Aucune offre disponible', 'exertio_theme' ).'</p>';
					}
					?>
			  </div>
					  </div>
