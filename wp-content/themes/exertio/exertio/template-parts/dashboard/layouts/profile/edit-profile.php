                  ...
                  <div class="form-row">
                    ...
                    <?php
						...
						else
						{
							...
							{
								$dpt_check = 'required data-smk-msg="'.esc_html__('Please select department','exertio_theme').'"';	
							}
						?>
                            <div class="form-group col-md-6">
                              ...
                              $department_taxonomies = exertio_get_terms('departments');
                                ...
                                {
                                    $dpt_check;
                                    $departments = '<select name="employer_department" class="form-control general_select" '.$dpt_check.'>';
						...
						else
						{
							...
							{
								$employee_check = 'required data-smk-msg="'.esc_html__('Please select number of employees','exertio_theme').'"';	
							}
						?>
                            <div class="form-group col-md-6">
