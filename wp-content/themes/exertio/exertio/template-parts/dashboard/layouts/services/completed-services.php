              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Job terminés','exertio_theme'); ?></h2>
                                ...
                                foreach( $result as $results ) 
                                {
                                    ...
                                    <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn">
                                        	<a href="?ext=completed-service-detail&sid=<?php echo esc_html($ongoing_sid); ?>" class="btn btn-theme-secondary"><?php echo esc_html__( 'Voir le détail', 'exertio_theme' ); ?></a>
                                        </div>
                                      </div>
                                    <?php
                                }
