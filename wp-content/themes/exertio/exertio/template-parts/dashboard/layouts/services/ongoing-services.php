	...
	if( is_user_logged_in() )
	 {
		...
		{
			$query = "SELECT * FROM ".$table." WHERE `buyer_id` = '" . $buyer_id . "' AND `status` ='ongoing' ORDER BY timestamp DESC LIMIT ".$start_from.",".$limit."";
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Jobs en cours','exertio_theme'); ?></h2>
                ...
                <div class="card-body">
                  <div class="pro-section">
                      <div class="pro-box heading-row">
                                ...
                                foreach( $result as $results ) 
                                {
                                    ...
                                    <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn buyer-detail">
                                            ...
                                            <span class="service_start_date"> <?php echo esc_html__( 'Commandé le ', 'exertio_theme' ).' '.esc_html(date("d/m/Y", strtotime($results->timestamp))); ?></span>
                                        </div>
                                        <div class="pro-coulmn">
                                        	<a href="?ext=ongoing-service-detail&sid=<?php echo esc_html($ongoing_sid); ?>" class="btn btn-theme-secondary"><?php echo esc_html__( 'Voir détail', 'exertio_theme' ); ?></a>
                                        </div>
                                      </div>
                                    <?php
                                }
						...
						echo pagination_ongoing_services_buyer($buyer_id, $pageno, $limit, 'ongoing'); 
						?>
                  </div>
                </div>
              </div>
