...
if( is_user_logged_in() )
 {
	...
	{
		$query = "SELECT * FROM ".$table." WHERE `id` = '" . $get_sid . "' AND `seller_id` = '" . $seller_id . "' AND `status` ='canceled' ORDER BY timestamp DESC LIMIT 1";
		...
		?>
            <div class="content-wrapper">
                  ...
                  <div class="d-flex justify-content-between flex-wrap">
                    <div class="d-flex align-items-end flex-wrap">
                      <div class="mr-md-3 mr-xl-5">
                        <h2><?php echo esc_html__('Détail du service rejeté','exertio_theme');?></h2>
              ...
              <div class="row">
                <div class="col-md-12 grid-margin stretch-card services ongoing-services-details cancel-service">
                  <div class="card mb-4">
                    <div class="card-body">
                            ...
                            <?php
                                ...
                                else
                                {
                                    ...
                                    <div class="nothing-found">
                                        <h3><?php echo esc_html__( 'Désolé!! Aucun service disponible pour le moment', 'exertio_theme' ) ?></h3>
            ...
            <!--CANCEL REMARKS-->
            <div class="modal fade review-modal" id="view-remarks" tabindex="-1" role="dialog" aria-labelledby="view-remarks" aria-hidden="true">
