      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Active Services','exertio_theme'); ?></h2>
            ...
            <div class="pro-box">
              <div class="pro-coulmn pro-title">
                ...
                if ( isset( $featured_service ) && $featured_service == 1 ) {
                  ?>
                <div class="features-star"><?php echo esc_html__( 'Featured', 'exertio_theme' ) ?></div>
                <?php
                }
                ?>
                <h4 class="pro-name"> <a href="<?php  echo esc_url(get_permalink()); ?>"><?php echo esc_html(get_the_title()); ?></a> </h4>
                <span class="pro-meta-box"> <span class="pro-meta"> <i class="fal fa-calendar-alt"></i> <?php echo	esc_html($posted_date); ?> </span> <span class="pro-meta">
                <?php
