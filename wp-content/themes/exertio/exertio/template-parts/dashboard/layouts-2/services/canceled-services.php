	...
	if( is_user_logged_in() )
	 {
		...
		{
			$query = "SELECT * FROM ".$table." WHERE `seller_id` = '" . $seller_id . "' AND `status` ='canceled' ORDER BY timestamp DESC LIMIT ".$start_from.",".$limit."";
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Job rejetés','exertio_theme');?></h2>
                ...
                <div class="card-body">
                  <div class="pro-section">
                      <div class="pro-box heading-row">
						...
						echo pagination_ongoing_services($seller_id, $pageno, $limit, 'canceled');
                        ?>
                  </div>
                </div>
              </div>
