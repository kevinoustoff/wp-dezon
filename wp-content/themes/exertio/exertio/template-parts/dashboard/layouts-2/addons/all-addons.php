      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Mes options supplémentaires','exertio_theme').esc_html(' ('. $total_count.')');?></h2>
				...
				<?php
					...
					else
					{
                        ...
                        <div class="nothing-found">
                            ...
                            <h3><?php echo esc_html__( 'Désolé!! Aucune option supplémentaire trouvée pour le moment', 'exertio_theme' ) ?></h3>
                        </div>
                        <?php	
					}
				?>
