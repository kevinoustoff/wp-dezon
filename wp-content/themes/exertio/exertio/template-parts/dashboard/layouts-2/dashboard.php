			...
			<div class="row">		
				<div class="col-md-6 col-lg-3">
					<div class="info-boxes">
						...
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=all-services"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						...
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=completed-services"> <?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?><i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						...
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=ongoing-services"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Avis sur le prestataire', 'exertio_theme' ); ?></span>
								<span class="number"><?php echo esc_html($rating); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>"><?php echo esc_html__('Voir le détail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
						...
						<?php
							...
							else
							{
								...
								<div class="nothing-found">
									...
									<h3><?php echo esc_html__( 'Désolé!!! Aucun achat effectué récemment', 'exertio_theme' ) ?></h3>
								</div>
								<?php	
							}
						?>
				...
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Pack actuel', 'exertio_theme' ); ?></h4>
					...
					<?php
						...
						$simple_services_text = isset( $simple_services) && $simple_services == -1 ? esc_html__(' Illimité ', 'exertio_theme' ) : $simple_services;
					
						$simple_services_expiry = get_post_meta( $freelancer_id, '_simple_service_expiry', true );
						$simple_services_expiry_text = isset( $simple_services_expiry) && $simple_services_expiry == -1 ? esc_html__(' N\'expire jamais', 'exertio_theme' ) : $simple_services_expiry.esc_html__(' Jours ', 'exertio_theme' );

						$featured_services = get_post_meta( $freelancer_id, '_featured_services', true );
						$featured_services_text = isset( $featured_services) && $featured_services == -1 ? esc_html__(' Illimité ', 'exertio_theme' ) : $featured_services;

						$featured_services_expiry = get_post_meta( $freelancer_id, '_featured_services_expiry', true );
						$featured_services_expiry_text = isset( $featured_services_expiry) && $featured_services_expiry == -1 ? esc_html__(' N\'expire jamais ', 'exertio_theme' ) : $featured_services_expiry.esc_html__(' Jours ', 'exertio_theme' );
