      ...
      <form class="modal-from new-my-pass" method="POST" id="mynewPass">
        ...
        <div class="fr-sign-form">
          ...
          <div class="form-group">
            <input type="password" required data-smk-msg="<?php echo esc_html__('New password is needed','exertio_theme'); ?>" name="password" class="form-control" placeholder="<?php echo esc_html__('Enter new password','exertio_theme'); ?>">
            </div>
            <div class="form-group">
