		...
		if(fl_framework_get_options('project_sidebar') == 'left')
		{
			...
			<div class="col-lg-4 col-xs-12 col-sm-12 col-md-12 col-xl-4">
            	<div class="project-sidebar">
                	<div class="heading">
                        <h4><?php echo esc_html__('Filtres de recherche','exertio_theme'); ?></h4>
                        <?php
                            $project_page = '';
                            $project_page = fl_framework_get_options('project_search_page');
                        ?>
                        <a href="<?php echo esc_url(get_the_permalink($project_page)); ?>"><?php echo esc_html__('Effacer les résultats','exertio_theme'); ?></a>
                    </div>
                ...
                <div class="services-filter-2">
                	<form>
							<div class="heading-area">
								<h4><?php echo esc_html__('Trouvé ','exertio_theme'). $results->found_posts. esc_html__(' Résultats ','exertio_theme'); ?> </h4>
							</div>
						<div class="filters">
