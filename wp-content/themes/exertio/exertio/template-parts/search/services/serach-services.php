            ...
            <ul>
              <li>
                <div class="form-group">
                  <input type="text" placeholder="<?php echo __( 'Que recherchez vous?', 'exertio_theme' ); ?>" class="form-control" name="title" value="<?php echo esc_attr($title_value); ?>">
                </div>
              </li>
              <li>
                <select class="default-select" name="categories">
                	<option value=""> <?php echo __( 'Selectionnez une catégorie', 'exertio_theme' ); ?> </option>
                  <?php echo get_hierarchical_terms('service-categories','', $cat_value ); ?>
                </select>
              </li>
              <li> <button type="submit" class="btn btn-style btn-block"><?php echo __( 'Rechercher', 'exertio_theme' ); ?></button> </li>
            </ul>
            </div>
            <?php
				if(isset($_GET) && $_GET != '')
		...
		if(isset($sidebar_postion) & $sidebar_postion == 'left')
		{
            ...
            <div class="col-xl-4 col-xs-12 col-sm-12 col-md-12">
                <div class="service-side position-sticky">
                    <div class="heading">
                        <h4><?php echo esc_html__('Filtre de recherche','exertio_theme'); ?></h4>
                        <?php
                            $services_page = '';
                            $services_page = fl_framework_get_options('services_search_page');
                        ?>
                        <a href="<?php echo esc_url(get_the_permalink($services_page)); ?>"><?php echo esc_html__('Effacer les résultats','exertio_theme'); ?></a>
                    </div>
                    ...
                    <form action="<?php echo get_the_permalink(fl_framework_get_options('services_search_page')); ?>">
                        ...
                        <div class="submit-btn">
                            ...
                            <button class="btn btn-theme btn-block" type="submit"> <?php echo esc_html__('Filtrer les résultats','exertio_theme'); ?></button>
                        </div>
                    </form>
                    </div>
                </div>
                    ...
                    <div class="services-filter-2">
                        <form>
								<div class="heading-area">
									<h4><?php echo esc_html__('Il y a  ','exertio_theme'). $results->found_posts. esc_html__(' Résultat(s) ','exertio_theme'); ?> </h4>
                                ...
                                <div class="filters">
									<ul class="top-filters">
                                            ...
                                            ?>
                                            <li>
                                                <a href="javascript:void(0)" class="services-list-icon protip <?php echo esc_attr($list_active); ?> list-style" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo __( 'List View', 'exertio_theme' ); ?>" data-list-style="list">
                                                    <span></span>
                                                    <span></span>
                                                    <span></span>
                                                </a>
                                    ...
                                    <select class="default-select" name="sort" id="order_by">
                                        <option value=""><?php echo __( 'Trier par', 'exertio_theme' ); ?></option>
                                        <option value="new-old" <?php if($sort == 'new-old'){ echo "selected"; } ?>> <?php echo __( 'Date récente vers ancienne', 'exertio_theme' ); ?></option>
                                        <option value="old-new" <?php if($sort == 'old-new'){ echo "selected"; } ?>> <?php echo __( 'Date ancienne vers récente', 'exertio_theme' ); ?></option>
                                    </select>
                                    <?php
                                    if(isset($_GET) && $_GET != '')
                                    {
