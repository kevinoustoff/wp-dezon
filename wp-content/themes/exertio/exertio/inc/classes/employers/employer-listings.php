                    ...
                    <div class="fr-employ-content">
                      ...
                      <div class="fr-employ-container"> 
                        ...
                        <div class="fr-employer-assets">
                            ...
                            {
                                ?>
                                <a href="javascript:void(0)" class="following protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_html__('Already Following','exertio_theme'); ?>"><i class="far fa-heart"></i></a>
                                <?php
                            }
                            else
                            {
							?>
                            <a href="javascript:void(0)" class="follow-employer protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_html__('Click to Follow','exertio_theme'); ?>" data-emp-id="<?php echo esc_attr($employer_id); ?>"><i class="far fa-heart"></i></a>
                    ...
                    ?>
					  <div class="fr3-box-img" <?php echo wp_return_echo($cover_img); ?>>
						  ...
						  <div class="fr3-box-icons">
                            ...
                            {
                                ?>
                                <a href="javascript:void(0)" class="following protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_html__('Already Following','exertio_theme'); ?>"><i class="fa fa-heart"></i></a>
                                <?php
                            }
                            else
                            {
                                ?>
                                <a href="javascript:void(0)" class="follow-employer protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_html__('Click to Follow','exertio_theme'); ?>" data-emp-id="<?php echo esc_attr($employer_id); ?>"><i class="fa fa-heart"></i></a>
