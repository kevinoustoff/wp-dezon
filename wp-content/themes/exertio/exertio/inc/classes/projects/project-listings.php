            	...
            	<div class="fr-right-detail-box">
                      ...
                      <div class="fr-jobs-price">
                        <div class="style-hd">
                        	<?php 
								...
								{
									$hourly_price = fl_price_separator(get_post_meta($project_id, '_project_cost', true));
									$estimated_hours = get_post_meta($project_id, '_estimated_hours', true);
									echo esc_html($hourly_price);
									
									$save_text = esc_html__( 'Heures estimées ', 'exertio_theme' ).$estimated_hours."<br><br>".esc_html__( 'Total: ', 'exertio_theme' ).get_post_meta($project_id, '_project_cost', true)."*".$estimated_hours."= ".fl_price_separator(get_post_meta($project_id, '_project_cost', true)*$estimated_hours);
									echo '<small class="protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="'.esc_html($save_text).'"><i class="far fa-question-circle"></i></small>';
								}
							 ?>
                        </div>
                        <p></p>
                        ...
                        <ul class="skills">
                        	<?php
								...
								foreach($saved_skills as $saved_skill)
								{
									...
									{ $skill_hide = 'hide'; }
									?>
                                    <li class="<?php echo esc_html($skill_hide); ?>"><a href="<?php echo $listings_link.'='.$saved_skill->term_id; ?>"><?php echo esc_html($saved_skill->name); ?></a></li>
									<?php
								  $skill_count++;
								}
								if($skill_hide != '')
                  ...
                  <div class="fr-right-information">
                    <div class="fr-right-list">
                      <ul>
                        <li>
                          <p class="heading"> <?php echo esc_html__( 'Expiration: ', 'exertio_theme' ); ?></p>
                          <div><?php echo project_expiry_calculation($project_id); ?></div>
                        </li>
                        <li>
                          <p class="heading"><?php echo esc_html__( 'Offres', 'exertio_theme' ); ?></p>
                          <?php
						  ...
						  ?>
                          <span><?php echo esc_html($results).esc_html__( ' Reçue(s) ', 'exertio_theme' ); ?></span>
                        </li>
                        <?php
                    ...
                    <div class="res-us-inline">
                      <ul>
                        ...
                        <li class="fr1-top-content">
                            ...
                            <p><a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__( 'Voir le projet', 'exertio_theme' ); ?></a></p>
                        </li>
                      </ul>
                    </div>
                    <?php
                ...
                <div class="fr-latest2-content-box">
				  ...
				  <div class="fr-latest2-price">
					<ul>
					  ...
					  <li> <span class="info-col"><?php echo esc_html__( 'Expiration', 'exertio_theme' ); ?></span>
						<?php echo project_expiry_calculation($project_id); ?>
					  </li>
					  <li> <span class="info-col"> <?php echo esc_html__( 'Offres', 'exertio_theme' ); ?></span>
						<p> <?php echo esc_html($bid_results).esc_html__( 'Reçue(s)', 'exertio_theme' ); ?></p>
					  </li>
					</ul>
				  </div>
