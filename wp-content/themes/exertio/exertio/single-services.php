                ...
                <ul>
                  ...
                  <li class="social-share">
                    <div id="wrapper">
                      ...
                      <label for="share" class="label fl-export"><i class="fal fa-share-alt"></i><span><?php echo esc_html__('Partager','exertio_theme'); ?></span></label>
                      <div class="social">
                        <ul>
                          ...
                          <li class="fl-instagram"><a  class="tumblr-share-button" href="http://www.tumblr.com/share?v=3&u=<?php  echo esc_url(get_permalink()); ?>2F&t="  target="_blank"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                      </div>
                    </div>
                  </li>
    ...
    <div class="row">
        ...
        <div class="fr-seller-servives-2" id="seller">
          <div class="fr-seller-servives">
            ...
            <div class="fr-seller-servives-meta"> <a href="<?php  echo esc_url(get_permalink($fid)); ?>">
              ...
              <div class="fr-seller-details"> <a href="<?php  echo esc_url(get_permalink($fid)); ?>"><span><i class="fa fa-check"></i><?php echo esc_html(get_post_meta( $fid, '_freelancer_dispaly_name' , true )); ?></span></a>
              ...
              <div class="fr-seller-view"> <a href="<?php  echo esc_url(get_permalink($fid)); ?>" class="btn btn-theme"><?php echo esc_html__('Voir le profil','exertio_theme'); ?></a> </div>
            </div>
          </div>
          <div class="fr-seller-contents">
            <ul>
              <li>
                <p><?php echo esc_html__('Localisation:','exertio_theme'); ?></p>
                <span>
                <?php
              ...
              <li>
                <p><?php echo esc_html__('Membre depuis:','exertio_theme'); ?></p>
                <span><?php echo date_i18n( get_option( 'date_format' ), strtotime( get_the_date('dS M Y', $fid) ) ); ?></span> </li>
            </ul>
          </div>
        </div>
        <?php
      ...
      <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
        <div class="service-sidebar position-sticky">
			...
			<div class="card-body">
			  <div class="row">
				<div class="col"> <span class="price-label"><?php echo esc_html__('A partir de ','exertio_theme'); ?></span>
				  <div class="price"><?php echo fl_price_separator(get_post_meta($sid, '_service_price', true), 'html'); ?></div>
				</div>
			...
			<div class="fr-services2-box">
						<form id="purchased_addon_form">
						  ...
						  <div class="fr-services2-h-style">
							<h3> <?php echo esc_html__('Services associés','exertio_theme'); ?></h3>
						  </div>
						  <?php
						  $args = array(
						  ...
						  <div class="fr-services-products">
							<div class="fr-services2-sm">
							  <div class="pretty p-default">
								<input type="checkbox" name="services_addon[]" value="<?php echo esc_attr( $addon_id ) ?>" class="fl_addon_checkbox" id="addon_checkbox_<?php echo esc_attr($addon_id); ?>" data-addon-id="<?php echo esc_attr( $addon_id ) ?>">
