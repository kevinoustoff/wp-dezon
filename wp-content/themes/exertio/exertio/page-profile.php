...
?>
        <div class="container-scroller">
            <div class="container-fluid page-body-wrapper">
                <?php
                if(empty($_COOKIE["active_profile"]) || $_COOKIE["active_profile"] == 'employer')
                {
              ...
              <div class="main-panel">
				...
				if(fl_framework_get_options('fl_user_email_verification') != null && fl_framework_get_options('fl_user_email_verification') == true)
				{
					...
					{
						$resent_msg = '<a href="javascript:void(0)" class="register_email_again"> '.esc_html__('Renvoyez un mail?','exertio_theme').'</a>';
					}
					else
					{
						$resent_msg = esc_html__('Renvoyez dans  ','exertio_theme'). $minutes.esc_html__(' minutes ','exertio_theme'). $seconds.esc_html__(' secondes','exertio_theme');
					}
					...
					if($is_verified != 1 || $is_verified == '')
					{
						...
						<div class="exertio-alert alert alert-danger alert-dismissible fade show" role="alert">
							<div class="exertio-alart-box">
								...
								<div class="text-info">
									<h5><?php echo esc_html__('Votre adresse email n\'est pas encore vérifiée','exertio_theme'); ?> </h5>
									<p>
										<?php echo esc_html__('Un lien de vérification vous sera envoyé par mail. ','exertio_theme'); ?>
